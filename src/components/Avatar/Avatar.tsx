...
const Avatar = (props: AvatarProps) => {
  ...
  const avatarUrl = useMemo(() => {
    ...
    if (!avatarUrl && props.user?.type === 'student') return 'https://cdn.nightzookeeper.com/edu-assets/images/empty-avatar.png'
  ...
  return <s.Wrapper size={props.size} colors={props.colors}>
