    ...
    <g data-name="Group 9780" clipPath="url(#update_svg__a)">
      <g data-name="Group 9779">
        <g data-name="Group 9778" clipPath="url(#update_svg__a)">
          ...
          <path
            data-name="Path 7717"
            d="M36.655 3.068a2.315 2.315 0 0 0-.907-1.219 3.094 3.094 0 0 0-2.506 1.564 21 21 0 0 0-2.859 7.45 4.438 4.438 0 0 0 1.467.823c5.344 1.9 6.245-4.129 4.8-8.618"
            fill="#ffd400"
          />
          <path
            data-name="Path 7718"
            d="M56.449 30.638c-2.818-5.771-6.924-21.575-19.437-22.2a11.989 11.989 0 0 0-5.518.494c-9.9 2.358-13.4 11.728-16.215 18C12.082 34.065 1.38 36.419 4.5 46.5s15.385 12.887 26.533 14.383c13.492 1.811 27.422-5.737 32.1-14.382s-3.791-9.926-6.689-15.863"
            fill="#ffd400"
          />
          <path
            data-name="Path 7719"
          ...
          <path
            data-name="Path 7720"
            d="M11.417 43.584a5.949 5.949 0 0 0 1.853 1.548c19.16 10.144 34.362 4.6 41.1.931-2.826-2.607-9.042-5.375-22.67-5.829-11.047-.369-17.2 1.2-20.285 3.35"
            fill="#aa621a"
          />
          <path
            data-name="Path 7721"
          ...
          <path
            data-name="Path 7726"
            d="M32.881 56.294a16.129 16.129 0 0 0-3.732-.685c-.684-.021-1.072-.012-1.523-.627a2.611 2.611 0 0 0-.853-.916 2.1 2.1 0 0 0-1.566.106 1.191 1.191 0 0 0-.516.276 1.169 1.169 0 0 0-.237.662c-.249 1.848-.6 3.97.731 5.477a7.856 7.856 0 0 0 4.571 2.393c3.125.457 7.363-.177 7.454-3.436a2.664 2.664 0 0 0-1.432-2.153 10.5 10.5 0 0 0-2.8-1.07l-.1-.027"
            fill="#ffd400"
          />
          <path
            data-name="Path 7727"
            d="M33.057 3.686a21.7 21.7 0 0 0-1.591 3.49.857.857 0 0 0-.071.394.657.657 0 0 0 .468.477 2.216 2.216 0 0 0 2.224-.984 5.45 5.45 0 0 0 1.162-2.1c.567-2.155-.907-3.536-2.192-1.273"
            fill="#ffe600"
          />
          <path
            data-name="Path 7728"
            d="M33.108 3.589a10.852 10.852 0 0 0-.8 1.745.436.436 0 0 0-.035.2.329.329 0 0 0 .234.239 1.109 1.109 0 0 0 1.112-.492 2.746 2.746 0 0 0 .581-1.055c.283-1.078-.453-1.768-1.1-.637"
            fill="#fff35a"
          />
        </g>
      </g>
