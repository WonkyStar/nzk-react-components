...
var Button = function (props) {
    return (
    // @ts-ignore
    r__default['default'].createElement(Wrapper$2
    // @ts-ignore
    , __assign({ 
        // @ts-ignore
...
var Icon = function (props) {
    var _a = r$1.useState(null), svg = _a[0], setSvg = _a[1];
    ...
    return r__default['default'].createElement(SvgWrapper, __assign({}, props), svg || null);
};
Icon.defaultProps = {
    size: null
};
...
var IconButton = (function (props) {
    ...
    return (r__default['default'].createElement(Wrapper$1, { overlap: 0.3 * W },
        r__default['default'].createElement(Button, __assign({}, props, { round: true, children: props.icon })),
        r__default['default'].createElement(Button, __assign({}, props))));
});
...
var Modal = function (props) {
    var title = r$1.useMemo(function () {
        if (props.errorMessage)
            return 'Error';
        return props.title;
    }, []);
    var content = r$1.useMemo(function () {
        if (props.errorMessage)
    ...
    var actions = r$1.useMemo(function () {
        if (props.actions)
            return props.actions;
        return null;
    }, []);
    return r__default['default'].createElement(Wrapper, null,
        props.dismiss && r__default['default'].createElement(QuitButton, { onClick: props.dismiss },
            r__default['default'].createElement(Button, { round: true, theme: 'red', size: 'regular' }, "X")),
        r__default['default'].createElement(Title, null, title),
        r__default['default'].createElement(Content, { hasError: Boolean(props.errorMessage && true) }, content),
        r__default['default'].createElement(Actions, null, Array.isArray(actions) && actions.map(function (action) { return action; })));
};
...
var useAsync = function (props) {
    ...
    var _b = r$1.useState(immediate), loading = _b[0], setLoading = _b[1];
    var _c = r$1.useState(initialData), data = _c[0], setData = _c[1];
    var _d = r$1.useState(null), error = _d[0], setError = _d[1];
    var mountedRef = r$1.useRef(true);
    var execute = r$1.useCallback(function (params) {
        setLoading(true);
