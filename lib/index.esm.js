import r$1, { useRef, useDebugValue, useContext, createElement, useState, useEffect, useMemo, useCallback } from 'react';
...
var Button = function (props) {
    return (
    // @ts-ignore
    r$1.createElement(Wrapper$2
    // @ts-ignore
    , __assign({ 
        // @ts-ignore
        height: props.size && SIZES[props.size] }, props, (props.theme ? THEMES[props.theme] : {}))));
};

var SvgWrapper = styled.div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  height: ", ";\n  width: ", ";\n  display: inline-flex;\n\n  svg {\n    width: 100% !important;\n    height: 100% !important;\n  }\n"], ["\n  height: ", ";\n  width: ", ";\n  display: inline-flex;\n\n  svg {\n    width: 100% !important;\n    height: 100% !important;\n  }\n"])), function (props) { return props.size; }, function (props) { return props.size; });
var Icon = function (props) {
    var _a = useState(null), svg = _a[0], setSvg = _a[1];
    useEffect(function () {
        importSvg();
    }, []);
    var importSvg = function () { return __awaiter(void 0, void 0, void 0, function () {
        var loadedSvg;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, require(("./assets/" ) + "icons/" + props.name + ".svg")];
                case 1:
                    loadedSvg = _a.sent();
    ...
    return r$1.createElement(SvgWrapper, __assign({}, props), svg || null);
};
Icon.defaultProps = {
    size: null
};
...
var IconButton = (function (props) {
    ...
    return (r$1.createElement(Wrapper$1, { overlap: 0.3 * W },
        r$1.createElement(Button, __assign({}, props, { round: true, children: props.icon })),
        r$1.createElement(Button, __assign({}, props))));
});
...
var Modal = function (props) {
    ...
    return r$1.createElement(Wrapper, null,
        props.dismiss && r$1.createElement(QuitButton, { onClick: props.dismiss },
            r$1.createElement(Button, { round: true, theme: 'red', size: 'regular' }, "X")),
        r$1.createElement(Title, null, title),
        r$1.createElement(Content, { hasError: Boolean(props.errorMessage && true) }, content),
        r$1.createElement(Actions, null, Array.isArray(actions) && actions.map(function (action) { return action; })));
};
...
var useAsync = function (props) {
    if (props === void 0) { props = initialProps; }
    var _a = __assign({}, props), asyncFunc = _a.asyncFunc, immediate = _a.immediate, funcParams = _a.funcParams, initialData = _a.initialData;
    var _b = useState(immediate), loading = _b[0], setLoading = _b[1];
    var _c = useState(initialData), data = _c[0], setData = _c[1];
    var _d = useState(null), error = _d[0], setError = _d[1];
    var mountedRef = useRef(true);
    var execute = useCallback(function (params) {
        setLoading(true);
        return asyncFunc(__assign(__assign({}, funcParams), params))
            .then(function (res) {
...
export { Button, Icon, IconButton, Modal, useAsync, useMountState };
